...
int main()
{
	...
	cv::FileStorage fs_calib("/home/shouyiyang/桌面/视觉实习生任务/任务5/相机内参及畸变参数.yml", cv::FileStorage::READ);  //打开校准文件calib_params.yml，进行读取操作，存储到 fs_calib 中
